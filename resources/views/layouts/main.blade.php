...
<head>
<meta charset="utf-8" />
<title>@yield('pageTitle') - CalsenCloud</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta content="Aplikasi Akuntansi & HRD" name="description" />
<meta content="Calsen Indonesia" name="author" />
<!-- CSRF Token -->
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{ asset('assets/images/loader.svg')}}" width="48" height="48" alt="CalsenCloud"></div>
        <p>Please wait...</p>
    </div>
</div>
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Dashboard</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="zmdi zmdi-home"></i> CalsenCloud</a></li>
