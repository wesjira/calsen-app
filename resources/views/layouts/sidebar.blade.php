<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{url('/')}}">
            <img src="{{ asset('images/logo/logo.png')}}" width="25" alt="CalsenCloud">
            <span class="m-l-10">CalsenCloud</span>
        </a>
    </div>
    <div class="menu">
        <ul class="list">
            ...
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="{{asset('images/users/default-avatar.png')}}" alt="User"></a>
                    <div class="detail">
                        <h4>Surya Kusu..</h4>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Components</span></a>
                <ul class="ml-menu">
                    <li><a href="ui_kit.html">CalsenCloud UI KIT</a></li>                    
